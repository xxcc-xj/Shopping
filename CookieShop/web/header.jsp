...
<!--header-->
<div class="header"  style="background: dimgrey">
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            ...
            <!--navbar-header-->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background: dimgrey">

                <ul class="nav navbar-nav" style="margin-left: 350px;">
                    <h1 style="color: white;margin: 20px;margin-left: 100px">购物商城</h1>
                    <li><a href="/index" <c:if test="${param.flag==1}">class="active"</c:if>>推荐</a></li>
<%--                    <li class="dropdown">--%>
...
<%--                        </ul>--%>
<%--                    </li>--%>
                    <li><a href="/goodsrecommend_list?type=2" <c:if test="${param.flag==3 && t==2}">class="active"</c:if>>商品</a></li>
...
<%--                        <li><a href="/user_logout" >退出</a></li>--%>
        ...
        <div class="header-info" style="margin-top: 80px;">
...
<%--            </div>--%>
            ...
            <div class="header-right cart" style="position: absolute;margin-left: 790px">
